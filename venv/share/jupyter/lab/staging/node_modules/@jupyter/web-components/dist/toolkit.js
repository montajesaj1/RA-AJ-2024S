...
__decorate$1([observable], Slider$1.prototype, "direction", void 0);
__decorate$1([observable], Slider$1.prototype, "isDragging", void 0);
__decorate$1([observable], Slider$1.prototype, "position", void 0);
__decorate$1([observable], Slider$1.prototype, "trackWidth", void 0);
__decorate$1([observable], Slider$1.prototype, "trackMinWidth", void 0);
__decorate$1([observable], Slider$1.prototype, "trackHeight", void 0);
__decorate$1([observable], Slider$1.prototype, "trackLeft", void 0);
__decorate$1([observable], Slider$1.prototype, "trackMinHeight", void 0);
__decorate$1([observable], Slider$1.prototype, "valueTextFormatter", void 0);
__decorate$1([attr({
  converter: nullableNumberConverter
...
__decorate$1([attr], Slider$1.prototype, "orientation", void 0);
__decorate$1([attr], Slider$1.prototype, "mode", void 0);
...
__decorate$1([observable], Switch$1.prototype, "defaultSlottedNodes", void 0);
 ...
 */
const jpAccordionItem = AccordionItem.compose({
 ...
 */
const jpAccordion = Accordion.compose({
  baseName: 'accordion',
 ...
 */
const jpAnchoredRegion = AnchoredRegion.compose({
 ...
 */
const jpBreadcrumb = Breadcrumb.compose({
  baseName: 'breadcrumb',
 ...
 */
const jpBreadcrumbItem = BreadcrumbItem.compose({
 ...
 */
const jpDataGridCell = DataGridCell.compose({
 ...
 */
const jpDataGridRow = DataGridRow.compose({
 ...
 */
const jpDataGrid = DataGrid.compose({
  baseName: 'data-grid',
 ...
 */
const jpDivider = Divider.compose({
  baseName: 'divider',
 ...
 */
const jpMenuItem = MenuItem.compose({
  baseName: 'menu-item',
 ...
 *
 */
const jpOption = ListboxOption.compose({
  baseName: 'option',
 ...
 */
const jpProgress = BaseProgress.compose({
  baseName: 'progress',
 ...
 */
const jpProgressRing = BaseProgress.compose({
 ...
 */
const jpSkeleton = Skeleton.compose({
  baseName: 'skeleton',
 ...
 */
const jpTabPanel = TabPanel.compose({
  baseName: 'tab-panel',
 ...
 */
const jpTooltip = Tooltip.compose({
  baseName: 'tooltip',
...
// Copyright (c) Jupyter Development Team.
const ltr = css` .expand-collapse-glyph{transform: rotate(0deg)}:host(.nested) .expand-collapse-button{left: var( --expand-collapse-button-nested-width, calc(${heightNumber} * -1px) )}:host([selected])::after{left: calc(${focusStrokeWidth} * 1px)}:host([expanded]) > .positioning-region .expand-collapse-glyph{transform: rotate(90deg)}`;
const rtl = css` .expand-collapse-glyph{transform: rotate(180deg)}:host(.nested) .expand-collapse-button{right: var( --expand-collapse-button-nested-width, calc(${heightNumber} * -1px) )}:host([selected])::after{right: calc(${focusStrokeWidth} * 1px)}:host([expanded]) > .positioning-region .expand-collapse-glyph{transform: rotate(90deg)}`;
/**
 ...
 *
 */
const jpTreeItem = TreeItem.compose({
  baseName: 'tree-item',
 ...
 *
 */
const jpTreeView = TreeView.compose({
  baseName: 'tree-view',
 ...
 */
const jpPickerMenuOption = PickerMenuOption.compose({
 ...
 *
 */
const jpPickerList = PickerList.compose({
 ...
 */
const jpPickerListItem = PickerListItem.compose({
