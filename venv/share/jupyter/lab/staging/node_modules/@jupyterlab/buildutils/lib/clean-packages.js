...
const baseConfig = (0, utils_1.readJSONFile)(path.join(basePath, 'package.json'));
const packageConfig = (_a = baseConfig.workspaces.packages) !== null && _a !== void 0 ? _a : baseConfig.workspaces;
