        ...
        return (React.createElement("div", { className: this.props.displayInput
            ...
            React.createElement("button", { className: !this.state.isFunctional
                    ...
                    : !this.state.isAvailable
                        ...
                        : 'jp-Shortcuts-Submit', id: 'no-blur', disabled: !this.state.isAvailable || !this.state.isFunctional, onClick: this.handleSubmit }, this.state.isAvailable ? React.createElement(checkIcon.react, null) : React.createElement(errorIcon.react, null))));
    }
}
