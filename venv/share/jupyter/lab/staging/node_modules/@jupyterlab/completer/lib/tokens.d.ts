...
export interface IInlineCompletionList<T extends IInlineCompletionItem = IInlineCompletionItem> {
    /**
 ...
 */
export interface IInlineCompletionProvider<T extends IInlineCompletionItem = IInlineCompletionItem> extends IInlineCompletionProviderInfo {
    /**
     ...
     */
    fetch(request: CompletionHandler.IRequest, context: IInlineCompletionContext): Promise<IInlineCompletionList<T>>;
    /**
     ...
     */
    stream?(token: string): AsyncGenerator<{
        response: T;
    }>;
}
/**
 ...
 */
export declare namespace IInlineCompleterFactory {
    /**
 ...
 */
export declare const IInlineCompleterFactory: Token<IInlineCompleterFactory>;
/**
...
export interface IProviderReconciliator {
     ...
     */
    fetchInline(request: CompletionHandler.IRequest, trigger?: InlineCompletionTriggerKind): Promise<IInlineCompletionList<CompletionHandler.IInlineItem> | null>[];
    /**
