 ...
 */
export declare function showErrorMessage(title: string, error: string | Dialog.IError, buttons?: ReadonlyArray<Dialog.IButton>): Promise<void>;
/**
...
export declare namespace Dialog {
    ...
    interface IRenderer {
         ...
         */
        createFooter(buttons: ReadonlyArray<HTMLElement>, checkbox: HTMLElement | null): Widget;
        /**
