"use strict";
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([[4503],{
...
__webpack_require__.d(__webpack_exports__, {
  "Accordion": () => (/* reexport */ index_js_.Accordion),
  "AccordionItem": () => (/* reexport */ index_js_.AccordionItem),
  "Anchor": () => (/* reexport */ Anchor),
  "AnchoredRegion": () => (/* reexport */ index_js_.AnchoredRegion),
  "Avatar": () => (/* reexport */ Avatar),
  "Badge": () => (/* reexport */ index_js_.Badge),
  "Breadcrumb": () => (/* reexport */ index_js_.Breadcrumb),
  "BreadcrumbItem": () => (/* reexport */ index_js_.BreadcrumbItem),
  "Button": () => (/* reexport */ Button),
  "Card": () => (/* reexport */ Card),
  "Checkbox": () => (/* reexport */ Checkbox),
  "Combobox": () => (/* reexport */ Combobox),
  "DataGrid": () => (/* reexport */ index_js_.DataGrid),
  "DataGridCell": () => (/* reexport */ index_js_.DataGridCell),
  "DataGridRow": () => (/* reexport */ index_js_.DataGridRow),
  "DelegatesARIAToolbar": () => (/* reexport */ DelegatesARIAToolbar),
  "DesignSystemProvider": () => (/* reexport */ DesignSystemProvider),
  "Dialog": () => (/* reexport */ index_js_.Dialog),
  "DirectionalStyleSheetBehavior": () => (/* reexport */ DirectionalStyleSheetBehavior),
  "Disclosure": () => (/* reexport */ Disclosure),
  "Divider": () => (/* reexport */ index_js_.Divider),
  "FoundationToolbar": () => (/* reexport */ FoundationToolbar),
  "Listbox": () => (/* reexport */ Listbox),
  "Menu": () => (/* reexport */ Menu),
  "MenuItem": () => (/* reexport */ index_js_.MenuItem),
  "NumberField": () => (/* reexport */ NumberField),
  "Option": () => (/* reexport */ index_js_.ListboxOption),
  "PaletteRGB": () => (/* reexport */ PaletteRGB),
  "Picker": () => (/* reexport */ index_js_.Picker),
  "PickerMenu": () => (/* reexport */ PickerMenu),
  "Progress": () => (/* reexport */ index_js_.BaseProgress),
  "ProgressRing": () => (/* reexport */ index_js_.BaseProgress),
  "Radio": () => (/* reexport */ Radio),
  "RadioGroup": () => (/* reexport */ RadioGroup),
  "Search": () => (/* reexport */ Search),
  "Select": () => (/* reexport */ Select),
  "Skeleton": () => (/* reexport */ index_js_.Skeleton),
  ...
  "Tab": () => (/* reexport */ index_js_.Tab),
  "TabPanel": () => (/* reexport */ index_js_.TabPanel),
  "Tabs": () => (/* reexport */ index_js_.Tabs),
  "TextArea": () => (/* reexport */ TextArea),
  "TextField": () => (/* reexport */ TextField),
  "Toolbar": () => (/* reexport */ Toolbar),
  "Tooltip": () => (/* reexport */ index_js_.Tooltip),
  "TreeItem": () => (/* reexport */ index_js_.TreeItem),
  "TreeView": () => (/* reexport */ index_js_.TreeView),
  ...
  "searchStyles": () => (/* reexport */ search_searchStyles),
...
var index_js_ = __webpack_require__(16904);
...
const { create: design_tokens_create } = index_js_.DesignToken;
function createNonCss(name) {
    return index_js_.DesignToken.create({ name, cssCustomPropertyName: null });
}
// General tokens
/** @public */
...
/** @public */
const direction = design_tokens_create('direction').withDefault(localization/* Direction.ltr */.N.ltr);
/** @public */
 ...
 * @public
 */
const heightNumberAsToken = index_js_.DesignToken.create({
    name: 'height-number',
    cssCustomPropertyName: null
 ...
 * @public
 */
const accordionStyles = (context, definition) => esm_index_js_.css `
  ${(0,index_js_.display)('flex')} :host {
 ...
 */
const heightNumber = esm_index_js_.cssPartial `(${baseHeightMultiplier} + ${density}) * ${designUnit}`;
 ...
 * @public
 */
const accordionItemStyles = (context, definition) => esm_index_js_.css `
    ${(0,index_js_.display)('flex')} :host {
      box-sizing: border-box;
      font-family: ${bodyFont};
      flex-direction: column;
    ...
    /* prettier-ignore */
    .button:${index_js_.focusVisible}::before {
      outline: none;
  ...
  `.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
      /* prettier-ignore */
      .button:${index_js_.focusVisible}::before {
 ...
 */
const jpAccordionItem = index_js_.AccordionItem.compose({
    baseName: 'accordion-item',
    template: index_js_.accordionItemTemplate,
 ...
 */
const jpAccordion = index_js_.Accordion.compose({
    baseName: 'accordion',
    template: index_js_.accordionTemplate,
 ...
 * @internal
 */
const BaseButtonStyles = esm_index_js_.css `
  ${(0,index_js_.display)('inline-flex')} :host {
    font-family: ${bodyFont};
    outline: none;
  ...
  /* prettier-ignore */
  .control:${index_js_.focusVisible} {
...
`.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
    ...
    :host([href]) .control:hover,
        :host([href]) .control:${index_js_.focusVisible} {
      forced-color-adjust: none;
 ...
 * @internal
 */
const AccentButtonStyles = esm_index_js_.css `
  ...
  :host([appearance="accent"]) .control:${index_js_.focusVisible} {
...
`.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
    ...
    :host([appearance="accent"][href]) .control:${index_js_.focusVisible} {
 ...
 * @internal
 */
const ErrorButtonStyles = esm_index_js_.css `
  ...
  :host([appearance="error"]) .control:${index_js_.focusVisible} {
...
`.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
    ...
    :host([appearance="error"][href]) .control:${index_js_.focusVisible} {
      outline-color: ${SystemColors.HighlightText};
    }
  `));
/**
 * @internal
 */
const HypertextStyles = esm_index_js_.css `
  ...
  :host([appearance="hypertext"]) .control:${index_js_.focusVisible} {
...
`.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
    ...
    :host([appearance="hypertext"][href]) .control:hover,
        ...
        :host([appearance="hypertext"][href]) .control:${index_js_.focusVisible} {
      color: ${SystemColors.LinkText};
 ...
 * @internal
 */
const LightweightButtonStyles = esm_index_js_.css `
  ...
  :host([appearance="lightweight"]) .control:${index_js_.focusVisible} {
    outline-color: transparent;
  }

  :host([appearance="lightweight"]) .control:${index_js_.focusVisible} .content::before {
...
`.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
    ...
    :host([appearance="lightweight"][href]) .control:hover,
        :host([appearance="lightweight"][href]) .control:${index_js_.focusVisible} {
      background: ${SystemColors.ButtonFace};
      box-shadow: none;
      color: ${SystemColors.LinkText};
    }
    ...
    :host([appearance="lightweight"][href]) .control:hover .content::before,
        :host([appearance="lightweight"][href]) .control:${index_js_.focusVisible} .content::before {
      background: ${SystemColors.LinkText};
    }
  `));
/**
 * @internal
 */
const OutlineButtonStyles = esm_index_js_.css `
  ...
  :host([appearance="outline"]) .control:${index_js_.focusVisible} {
    outline-color: ${accentFillFocus};
  }
`.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
    :host([appearance='outline']) .control {
    ...
    :host([appearance="outline"][href]) .control:hover,
        :host([appearance="outline"][href]) .control:${index_js_.focusVisible} {
      forced-color-adjust: none;
      outline-color: ${SystemColors.LinkText};
    }
  `));
 ...
 * @internal
 */
const StealthButtonStyles = esm_index_js_.css `
  ...
  :host([appearance='stealth']) .control:${index_js_.focusVisible} {
    outline-color: ${accentFillFocus};
  }
`.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
    :host([appearance='stealth']),
    ...
    :host([appearance="stealth"]:${index_js_.focusVisible}) .control {
      outline-color: ${SystemColors.Highlight};
      color: ${SystemColors.HighlightText};
      fill: currentColor;
    }
    ...
    :host([appearance="stealth"][href]:hover) .control,
        :host([appearance="stealth"][href]:${index_js_.focusVisible}) .control {
      background: ${SystemColors.LinkText};
      border-color: ${SystemColors.LinkText};
      color: ${SystemColors.HighlightText};
      fill: currentColor;
...
function appearanceBehavior(value, styles) {
    return new index_js_.PropertyStyleSheetBehavior('appearance', value, styles);
}
 ...
 * @public
 */
const anchorStyles = (context, definition) => esm_index_js_.css `
    ${BaseButtonStyles}
 ...
 * @public
 */
class Anchor extends index_js_.Anchor {
 ...
 */
const jpAnchor = Anchor.compose({
    baseName: 'anchor',
    baseClass: index_js_.Anchor,
    template: index_js_.anchorTemplate,
    styles: anchorStyles,
    shadowOptions: {
        delegatesFocus: true
    }
 ...
 * @public
 */
const anchoredRegionStyles = (context, definition) => esm_index_js_.css `
  :host {
    contain: layout;
    display: block;
  }
 ...
 */
const jpAnchoredRegion = index_js_.AnchoredRegion.compose({
    baseName: 'anchored-region',
    template: index_js_.anchoredRegionTemplate,
...
const rtl = (context, definition) => esm_index_js_.css `
  ::slotted(${context.tagFor(index_js_.Badge)}) {
    left: 0;
  }
`;
const ltr = (context, definition) => esm_index_js_.css `
  ::slotted(${context.tagFor(index_js_.Badge)}) {
    right: 0;
  }
`;
 ...
 * @public
 */
const avatarStyles = (context, definition) => esm_index_js_.css `
    ${(0,index_js_.display)('flex')} :host {
      position: relative;
 ...
 *
 */
class Avatar extends index_js_.Avatar {
}
__decorate([
    (0,esm_index_js_.attr)({ attribute: 'src' })
 ...
 *
 */
const imgTemplate = esm_index_js_.html `
  ${(0,esm_index_js_.when)(x => x.imgSrc, esm_index_js_.html `
      <img
        src="${x => x.imgSrc}"
        alt="${x => x.alt}"
        slot="media"
 ...
 */
const jpAvatar = Avatar.compose({
    baseName: 'avatar',
    baseClass: index_js_.Avatar,
    template: index_js_.avatarTemplate,
    styles: avatarStyles,
    media: imgTemplate,
    shadowOptions: {
        delegatesFocus: true
 ...
 * @public
 */
const badgeStyles = (context, definition) => esm_index_js_.css `
  ${(0,index_js_.display)('inline-block')} :host {
    box-sizing: border-box;
    font-family: ${bodyFont};
    font-size: ${typeRampMinus1FontSize};
    line-height: ${typeRampMinus1LineHeight};
 ...
 */
const jpBadge = index_js_.Badge.compose({
    baseName: 'badge',
    template: index_js_.badgeTemplate,
    styles: badgeStyles
});
/**
 ...
 * @public
 */
const breadcrumbStyles = (context, definition) => esm_index_js_.css `
  ${(0,index_js_.display)('inline-block')} :host {
    box-sizing: border-box;
    font-family: ${bodyFont};
    font-size: ${typeRampBaseFontSize};
 ...
 */
const jpBreadcrumb = index_js_.Breadcrumb.compose({
    baseName: 'breadcrumb',
    template: index_js_.breadcrumbTemplate,
 ...
 * @public
 */
const breadcrumbItemStyles = (context, definition) => esm_index_js_.css `
    ${(0,index_js_.display)('inline-flex')} :host {
        background: transparent;
        box-sizing: border-box;
        font-family: ${bodyFont};
    ...
    .control:${index_js_.focusVisible} .content::before {
 ...
 */
const jpBreadcrumbItem = index_js_.BreadcrumbItem.compose({
    baseName: 'breadcrumb-item',
    template: index_js_.breadcrumbItemTemplate,
 ...
 * @public
 */
const buttonStyles = (context, definition) => esm_index_js_.css `
    :host([disabled]),
    :host([disabled]:hover),
    :host([disabled]:active) {
      opacity: ${disabledOpacity};
      background-color: ${neutralFillRest};
      cursor: ${index_js_.disabledCursor};
    }
  ...
  `.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
    ...
    `), appearanceBehavior('accent', esm_index_js_.css `
      ...
      `.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
        ...
        `))), appearanceBehavior('error', esm_index_js_.css `
      ...
      `.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
        ...
        `))), appearanceBehavior('lightweight', esm_index_js_.css `
      ...
      `.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
        ...
        `))), appearanceBehavior('outline', esm_index_js_.css `
      ...
      `.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
        ...
        `))), appearanceBehavior('stealth', esm_index_js_.css `
        ${StealthButtonStyles}
      `.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
 ...
 * @internal
 */
class Button extends index_js_.Button {
    constructor() {
        super(...arguments);
        /**
...
__decorate([
    (0,esm_index_js_.attr)({ attribute: 'minimal', mode: 'boolean' })
 ...
 * {@link https://developer.mozilla.org/en-US/docs/Web/API/ShadowRoot/delegatesFocus | delegatesFocus}
 */
const jpButton = Button.compose({
    baseName: 'button',
    baseClass: index_js_.Button,
    template: index_js_.buttonTemplate,
    styles: buttonStyles,
    shadowOptions: {
        delegatesFocus: true
    }
 ...
 * @public
 */
const cardStyles = (context, definition) => esm_index_js_.css `
    ${(0,index_js_.display)('block')} :host {
      --elevation: 4;
      display: block;
      contain: content;
 ...
 * @internal
 */
class Card extends index_js_.Card {
    connectedCallback() {
        super.connectedCallback();
        const parent = (0,index_js_.composedParent)(this);
        if (parent) {
            fillColor.setValueFor(this, (target) => neutralFillLayerRecipe.getValueFor(target)
 ...
 */
const jpCard = Card.compose({
    baseName: 'card',
    baseClass: index_js_.Card,
    template: index_js_.cardTemplate,
    styles: cardStyles
});
 ...
 * @public
 */
const checkboxStyles = (context, definition) => esm_index_js_.css `
    ${(0,index_js_.display)('inline-flex')} :host {
      align-items: center;
      outline: none;
    ...
    :host(:${index_js_.focusVisible}) .control {
      outline: calc(${focusStrokeWidth} * 1px) solid ${accentFillFocus};
      outline-offset: 2px;
    }

    :host([aria-invalid='true']:${index_js_.focusVisible}) .control {
      outline-color: ${errorFillFocus};
    }
    ...
    :host([aria-checked="true"]:${index_js_.focusVisible}:not([disabled])) .control {
      outline: calc(${focusStrokeWidth} * 1px) solid ${accentFillFocus};
      outline-offset: 2px;
    }

    :host([aria-invalid='true'][aria-checked="true"]:${index_js_.focusVisible}:not([disabled])) .control {
      outline-color: ${errorFillFocus};
    }
 ...
 * @public
 */
const checkboxTemplate = (context, definition) => esm_index_js_.html `
  <template
    role="checkbox"
  ...
  >
    ...
    : 'label label__hidden'}"
    >
      <slot ${(0,esm_index_js_.slotted)('defaultSlottedNodes')}></slot>
    </label>
  </template>
`;
/**
 ...
 * @public
 */
class Checkbox extends index_js_.Checkbox {
 ...
 */
const jpCheckbox = Checkbox.compose({
    baseName: 'checkbox',
    baseClass: index_js_.Checkbox,
...
const listboxStyles = (context, definition) => {
    const ListboxOptionTag = context.tagFor(index_js_.ListboxOption);
    const hostContext = context.name === context.tagFor(index_js_.ListboxElement) ? '' : '.listbox';
    // The expression interpolations present in this block cause Prettier to generate
    // various formatting bugs.
    // prettier-ignore
    return esm_index_js_.css `
        ${!hostContext ? (0,index_js_.display)('inline-flex') : ''}
        ...
        ${!hostContext ? esm_index_js_.css `
:host(:${index_js_.focusVisible}:not([disabled])) {
                outline: none;
            }
    ...
    `.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
                :host(:not([multiple]):${index_js_.focusVisible}) ::slotted(${ListboxOptionTag}[aria-selected="true"]),
                :host([multiple]:${index_js_.focusVisible}) ::slotted(${ListboxOptionTag}[aria-checked="true"]) {
                    border-color: ${SystemColors.ButtonText};
...
const selectStyles = (context, definition) => {
    const selectContext = context.name === context.tagFor(index_js_.Select);
    // The expression interpolations present in this block cause Prettier to generate
    // various formatting bugs.
    // prettier-ignore
    return esm_index_js_.css `
  ${(0,index_js_.display)('inline-flex')}
  ...
  ${selectContext ? esm_index_js_.css `
  ...
  :host(:${index_js_.focusVisible}) {
    border-color: ${accentFillFocus};
    box-shadow: 0 0 0 calc((${focusStrokeWidth} - ${strokeWidth}) * 1px)
    ${accentFillFocus};
  }
  
  :host([aria-invalid='true']:${index_js_.focusVisible}) {
    border-color: ${errorFillFocus};
    box-shadow: 0 0 0 calc((${focusStrokeWidth} - ${strokeWidth}) * 1px)
    ${errorFillFocus};
  }
  
  :host(:not([size]):not([multiple]):not([open]):${index_js_.focusVisible}),
  :host([multiple]:${index_js_.focusVisible}),
  :host([size]:${index_js_.focusVisible}) {
    box-shadow: 0 0 0 calc((${focusStrokeWidth} - ${strokeWidth}) * 1px)
    ${accentFillFocus};
  }
  
  :host([aria-invalid='true']:not([size]):not([multiple]):not([open]):${index_js_.focusVisible}),
  :host([aria-invalid='true'][multiple]:${index_js_.focusVisible}),
  :host([aria-invalid='true'][size]:${index_js_.focusVisible}) {
    box-shadow: 0 0 0 calc((${focusStrokeWidth} - ${strokeWidth}) * 1px)
    ${errorFillFocus};
  }
  
  :host(:not([multiple]):not([size]):${index_js_.focusVisible}) ::slotted(${context.tagFor(index_js_.ListboxOption)}[aria-selected="true"]:not([disabled])) {
  ...
  `.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
      ...
      :host(:not([disabled]):${index_js_.focusVisible}) {
        background-color: ${SystemColors.ButtonFace};
      ...
      :host(:not([disabled]):${index_js_.focusVisible}) .listbox {
        background: ${SystemColors.ButtonFace};
      }
      ...
      :host(:${index_js_.focusVisible}) ::slotted([aria-selected="true"][role="option"]),
      :host(:${index_js_.focusVisible}) ::slotted(option[aria-selected="true"]),
      :host(:${index_js_.focusVisible}) ::slotted([aria-selected="true"][role="option"]:not([disabled])) {
        background: ${SystemColors.Highlight};
        border-color: ${SystemColors.ButtonText};
        box-shadow: 0 0 0 calc((${focusStrokeWidth} - ${strokeWidth}) * 1px)
 ...
 * @public
 */
const comboboxStyles = (context, definition) => esm_index_js_.css `
  ...
  .selected-value:hover,
    .selected-value:${index_js_.focusVisible},
 ...
 * @public
 */
class Combobox extends index_js_.Combobox {
    /**
    ...
    updateComputedStylesheet() {
        ...
        this.computedStylesheet = esm_index_js_.css `
      :host {
...
__decorate([
    (0,esm_index_js_.attr)({ attribute: 'autowidth', mode: 'boolean' })
 ...
 *
 */
const jpCombobox = Combobox.compose({
    baseName: 'combobox',
    baseClass: index_js_.Combobox,
    template: index_js_.comboboxTemplate,
 ...
 * @public
 */
const dataGridStyles = (context, definition) => esm_index_js_.css `
  :host {
    display: flex;
    position: relative;
    flex-direction: column;
 ...
 * @public
 */
const dataGridRowStyles = (context, definition) => esm_index_js_.css `
  :host {
    display: grid;
    padding: 1px 0;
    box-sizing: border-box;
 ...
 * @public
 */
const dataGridCellStyles = (context, definition) => esm_index_js_.css `
    :host {
 ...
 */
const jpDataGridCell = index_js_.DataGridCell.compose({
    baseName: 'data-grid-cell',
    template: index_js_.dataGridCellTemplate,
 ...
 */
const jpDataGridRow = index_js_.DataGridRow.compose({
    baseName: 'data-grid-row',
    template: index_js_.dataGridRowTemplate,
 ...
 */
const jpDataGrid = index_js_.DataGrid.compose({
    baseName: 'data-grid',
    template: index_js_.dataGridTemplate,
...
class _DateField extends index_js_.FoundationElement {
}
/**
 ...
 * @internal
 */
class FormAssociatedDateField extends (0,index_js_.FormAssociated)(_DateField) {
    constructor() {
        super(...arguments);
...
__decorate([
    (0,esm_index_js_.attr)({ attribute: 'readonly', mode: 'boolean' })
], DateField.prototype, "readOnly", void 0);
__decorate([
    (0,esm_index_js_.attr)({ mode: 'boolean' })
], DateField.prototype, "autofocus", void 0);
__decorate([
    esm_index_js_.attr
], DateField.prototype, "list", void 0);
__decorate([
    (0,esm_index_js_.attr)({ converter: esm_index_js_.nullableNumberConverter })
], DateField.prototype, "step", void 0);
__decorate([
    (0,esm_index_js_.attr)({ converter: nullableDateConverter })
], DateField.prototype, "max", void 0);
__decorate([
    (0,esm_index_js_.attr)({ converter: nullableDateConverter })
], DateField.prototype, "min", void 0);
__decorate([
    esm_index_js_.observable
], DateField.prototype, "defaultSlottedNodes", void 0);
(0,index_js_.applyMixins)(DateField, index_js_.StartEnd, index_js_.DelegatesARIATextbox);
...
const BaseFieldStyles = esm_index_js_.css `
  ${(0,index_js_.display)('inline-block')} :host {
    font-family: ${bodyFont};
    outline: none;
    user-select: none;
 ...
 * @public
 */
const dateFieldStyles = (context, definition) => esm_index_js_.css `
  ${BaseFieldStyles}
`;
 ...
 * @public
 */
const dateFieldTemplate = (context, definition) => esm_index_js_.html `
  <template class="${x => (x.readOnly ? 'readonly' : '')}">
    ...
    >
      <slot
        ${(0,esm_index_js_.slotted)({
    property: 'defaultSlottedNodes',
    filter: index_js_.whitespaceFilter
})}
      ></slot>
    </label>
    <div class="root" part="root">
      ${(0,index_js_.startSlotTemplate)(context, definition)}
      <input
        class="control"
        part="control"
        id="control"
        ...
        ${(0,esm_index_js_.ref)('control')}
      />
      ${(0,index_js_.endSlotTemplate)(context, definition)}
    </div>
  </template>
`;
...
const backgroundStyles = esm_index_js_.css `
  :host {
 ...
 * @internal
 */
class DesignSystemProvider extends index_js_.FoundationElement {
    constructor() {
        super();
        /**
        ...
        esm_index_js_.Observable.getNotifier(this).subscribe(subscriber, 'fillColor');
        esm_index_js_.Observable.getNotifier(this).subscribe(subscriber, 'baseLayerLuminance');
    }
    noPaintChanged() {
        if (!this.noPaint &&
...
__decorate([
    (0,esm_index_js_.attr)({ attribute: 'no-paint', mode: 'boolean' })
], DesignSystemProvider.prototype, "noPaint", void 0);
__decorate([
    (0,esm_index_js_.attr)({
...
__decorate([
    (0,esm_index_js_.attr)({
        converter: esm_index_js_.nullableNumberConverter
    }),
    designToken(density)
 ...
 * @public
 */
const designSystemProviderTemplate = (context, definition) => esm_index_js_.html ` <slot></slot> `;
/**
 * Styles for DesignSystemProvider.
 * @public
 */
const designSystemProviderStyles = (context, definition) => esm_index_js_.css `
  ${(0,index_js_.display)('block')}
`;
/**
 ...
 * @public
 */
const dialogStyles = (context, definition) => esm_index_js_.css `
  :host([hidden]) {
    display: none;
  }
 ...
 *
 */
const jpDialog = index_js_.Dialog.compose({
    baseName: 'dialog',
    template: index_js_.dialogTemplate,
    styles: dialogStyles
});
/**
 ...
 * @public
 */
const disclosureStyles = (context, definition) => esm_index_js_.css `
  .disclosure {
 ...
 * @internal
 */
class Disclosure extends index_js_.Disclosure {
    constructor() {
        super(...arguments);
        /**
 ...
 *
 */
const jpDisclosure = Disclosure.compose({
    baseName: 'disclosure',
    baseClass: index_js_.Disclosure,
    template: index_js_.disclosureTemplate,
 ...
 * @public
 */
const dividerStyles = (context, definition) => esm_index_js_.css `
  ${(0,index_js_.display)('block')} :host {
 ...
 */
const jpDivider = index_js_.Divider.compose({
    baseName: 'divider',
    template: index_js_.dividerTemplate,
 ...
 * @public
 */
class Listbox extends index_js_.ListboxElement {
    /**
 ...
 *
 */
const jpListbox = Listbox.compose({
    baseName: 'listbox',
    baseClass: index_js_.ListboxElement,
    template: index_js_.listboxTemplate,
 ...
 * @public
 */
const menuStyles = (context, definition) => esm_index_js_.css `
    ${(0,index_js_.display)('block')} :host {
      --elevation: 11;
      background: ${fillColor};
      border: calc(${strokeWidth} * 1px) solid transparent;
 ...
 * @public
 */
class Menu extends index_js_.Menu {
    /**
     * @internal
     */
    connectedCallback() {
 ...
 */
const jpMenu = Menu.compose({
    baseName: 'menu',
    template: index_js_.menuTemplate,
    styles: menuStyles
});
 ...
 * @public
 */
const menuItemStyles = (context, definition) => esm_index_js_.css `
    ${(0,index_js_.display)('grid')} :host {
      contain: layout;
      overflow: visible;
      font-family: ${bodyFont};
      outline: none;
  ...
  `.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
      ...
      :host(:hover) .expanded-toggle,
            :host(:hover) .checkbox,
            :host(:hover) .radio,
            :host(:${index_js_.focusVisible}) .expanded-toggle,
            :host(:${index_js_.focusVisible}) .checkbox,
            :host(:${index_js_.focusVisible}) .radio,
            :host([checked="true"]:hover) .checkbox,
            :host([checked="true"]:hover) .radio,
            :host([checked="true"]:${index_js_.focusVisible}) .checkbox,
            :host([checked="true"]:${index_js_.focusVisible}) .radio {
        border-color: ${SystemColors.HighlightText};
      }
      ...
      :host(:hover) ::slotted([slot="end"]:not(svg)),
            :host(:${index_js_.focusVisible}) ::slotted([slot="end"]:not(svg)) {
        color: ${SystemColors.HighlightText};
      }
    `), new DirectionalStyleSheetBehavior(esm_index_js_.css `
        .expand-collapse-glyph {
 ...
 */
const jpMenuItem = index_js_.MenuItem.compose({
    baseName: 'menu-item',
    template: index_js_.menuItemTemplate,
 ...
 * @public
 */
const numberFieldStyles = (context, definition) => esm_index_js_.css `
  ${BaseFieldStyles}
 ...
 * @internal
 */
class NumberField extends index_js_.NumberField {
    constructor() {
        super(...arguments);
        /**
 ...
 * {@link https://developer.mozilla.org/en-US/docs/Web/API/ShadowRoot/delegatesFocus | delegatesFocus}
 */
const jpNumberField = NumberField.compose({
    baseName: 'number-field',
    baseClass: index_js_.NumberField,
    styles: numberFieldStyles,
    template: index_js_.numberFieldTemplate,
    shadowOptions: {
        delegatesFocus: true
    },
    stepDownGlyph: /* html */ `
 ...
 * @public
 */
const optionStyles = (context, definition) => esm_index_js_.css `
    ${(0,index_js_.display)('inline-flex')} :host {
      align-items: center;
      font-family: ${bodyFont};
      border-radius: calc(${controlCornerRadius} * 1px);
 ...
 *
 */
const jpOption = index_js_.ListboxOption.compose({
    baseName: 'option',
    template: index_js_.listboxOptionTemplate,
    styles: optionStyles
});
/**
 ...
 * @public
 */
const progressStyles = (context, definition) => esm_index_js_.css `
    ${(0,index_js_.display)('flex')} :host {
      align-items: center;
      outline: none;
 ...
 */
const jpProgress = index_js_.BaseProgress.compose({
    baseName: 'progress',
    template: index_js_.progressTemplate,
 ...
 * @public
 */
const progressRingStyles = (context, definition) => esm_index_js_.css `
    ${(0,index_js_.display)('flex')} :host {
      align-items: center;
      outline: none;
      height: calc(${heightNumber} * 1px);
 ...
 */
const jpProgressRing = index_js_.BaseProgress.compose({
    baseName: 'progress-ring',
    template: index_js_.progressRingTemplate,
 ...
 * @public
 */
const radioStyles = (context, definition) => esm_index_js_.css `
    ${(0,index_js_.display)('inline-flex')} :host {
...
const radioTemplate = (context, definition) => esm_index_js_.html `
  <template
    role="radio"
    aria-checked="${x => x.checked}"
    aria-required="${x => x.required}"
 ...
 * @public
 */
class Radio extends index_js_.Radio {
}
/**
 ...
 */
const jpRadio = Radio.compose({
    baseName: 'radio',
    baseClass: index_js_.Radio,
 ...
 * @public
 */
const radioGroupStyles = (context, definition) => esm_index_js_.css `
  ${(0,index_js_.display)('flex')} :host {
 ...
 * @public
 */
class RadioGroup extends index_js_.RadioGroup {
    constructor() {
        super();
        // FIXME work around for private slottedRadioButtonsChanged
        const notifier = esm_index_js_.Observable.getNotifier(this);
        const handler = {
 ...
 */
const jpRadioGroup = RadioGroup.compose({
    baseName: 'radio-group',
    baseClass: index_js_.RadioGroup,
    template: index_js_.radioGroupTemplate,
...
const clearButtonHover = index_js_.DesignToken.create('clear-button-hover').withDefault((target) => {
...
const clearButtonActive = index_js_.DesignToken.create('clear-button-active').withDefault((target) => {
    const buttonRecipe = neutralFillStealthRecipe.getValueFor(target);
    const inputRecipe = neutralFillRecipe.getValueFor(target);
    return buttonRecipe.evaluate(target, inputRecipe.evaluate(target).hover)
        .active;
});
const searchStyles = (context, definition) => esm_index_js_.css `
  ${BaseFieldStyles}
 ...
 * @internal
 */
class Search extends index_js_.Search {
    constructor() {
        super(...arguments);
        /**
         * The appearance of the element.
 ...
 * {@link https://developer.mozilla.org/en-US/docs/Web/API/ShadowRoot/delegatesFocus | delegatesFocus}
 */
const jpSearch = Search.compose({
    baseName: 'search',
    baseClass: index_js_.Search,
    template: index_js_.searchTemplate,
    styles: searchStyles,
    shadowOptions: {
        delegatesFocus: true
    }
 ...
 * @public
 */
const search_searchStyles = searchStyles;
 ...
 * @public
 */
class Select extends index_js_.Select {
    constructor() {
        super(...arguments);
        /**
...
__decorate([
    (0,esm_index_js_.attr)({ attribute: 'autowidth', mode: 'boolean' })
], Select.prototype, "autoWidth", void 0);
__decorate([
    (0,esm_index_js_.attr)({ attribute: 'minimal', mode: 'boolean' })
], Select.prototype, "minimal", void 0);
__decorate([
    esm_index_js_.observable
 ...
 *
 */
const jpSelect = Select.compose({
    baseName: 'select',
    baseClass: index_js_.Select,
    template: index_js_.selectTemplate,
    styles: selectStyles,
    indicator: /* html */ `
        <svg
            class="select-indicator"
 ...
 * @public
 */
const skeletonStyles = (context, definition) => esm_index_js_.css `
    ${(0,index_js_.display)('block')} :host {
    ...
    ${(0,index_js_.display)('block')} span.shimmer {
      position: absolute;
      width: 100%;
      height: 100%;
 ...
 */
const jpSkeleton = index_js_.Skeleton.compose({
    baseName: 'skeleton',
    template: index_js_.skeletonTemplate,
...
const slider_styles_ltr = esm_index_js_.css `
  .track-start {
    left: 0;
  }
`;
const slider_styles_rtl = esm_index_js_.css `
  .track-start {
    right: 0;
  }
`;
 ...
 * @public
 */
const sliderStyles = (context, definition) => esm_index_js_.css `
    :host([hidden]) {
      display: none;
    }

    ${(0,index_js_.display)('inline-grid')} :host {
    ...
    :host(:${index_js_.focusVisible}) .thumb-cursor {
      box-shadow:
        0 0 0 2px ${fillColor},
        0 0 0 calc((2 + ${focusStrokeWidth}) * 1px) ${accentFillFocus};
    }

    :host([aria-invalid='true']:${index_js_.focusVisible}) .thumb-cursor {
      box-shadow:
        0 0 0 2px ${fillColor},
  ...
  `.withBehaviors(new DirectionalStyleSheetBehavior(slider_styles_ltr, slider_styles_rtl), (0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
      .thumb-cursor {
        forced-color-adjust: none;
        border-color: ${SystemColors.FieldText};
        background: ${SystemColors.FieldText};
 ...
 * @public
 */
class Slider extends index_js_.Slider {
}
/**
 ...
 */
const jpSlider = Slider.compose({
    baseName: 'slider',
    baseClass: index_js_.Slider,
    template: index_js_.sliderTemplate,
    styles: sliderStyles,
    thumb: /* html */ `
 ...
 * @public
 */
const horizontalSliderLabelStyles = esm_index_js_.css `
  :host {
    align-self: start;
    grid-row: 2;
    margin-top: -2px;
 ...
 * @public
 */
const verticalSliderLabelStyles = esm_index_js_.css `
  :host {
    justify-self: start;
    grid-column: 2;
    margin-left: 2px;
 ...
 * @public
 */
const sliderLabelStyles = (context, definition) => esm_index_js_.css `
    ${(0,index_js_.display)('block')} :host {
      font-family: ${bodyFont};
      color: ${neutralForegroundRest};
      fill: currentcolor;
 ...
 * @internal
 */
class SliderLabel extends index_js_.SliderLabel {
 ...
 */
const jpSliderLabel = SliderLabel.compose({
    baseName: 'slider-label',
    baseClass: index_js_.SliderLabel,
    template: index_js_.sliderLabelTemplate,
 ...
 * @public
 */
const switchStyles = (context, definition) => esm_index_js_.css `
    :host([hidden]) {
      display: none;
    }
 ...
 */ ''} user-select: none;
    ...
    :host(:${index_js_.focusVisible}) .switch {
      outline-offset: 2px;
      outline: solid calc(${focusStrokeWidth} * 1px) ${accentFillFocus};
    }

    :host([aria-invalid='true']:${index_js_.focusVisible}) .switch {
      outline-color: ${errorFillFocus};
    }
    ...
    :host([aria-checked="true"]:${index_js_.focusVisible}:not([disabled])) .switch {
      outline: solid calc(${focusStrokeWidth} * 1px) ${accentFillFocus};
    }

    :host([aria-invalid='true'][aria-checked="true"]:${index_js_.focusVisible}:not([disabled])) .switch {
      outline-color: ${errorFillFocus};
    }
 ...
 * @public
 */
class Switch extends index_js_.Switch {
}
/**
 ...
 */
const jpSwitch = Switch.compose({
    baseName: 'switch',
    baseClass: index_js_.Switch,
    template: index_js_.switchTemplate,
    styles: switchStyles,
    switch: /* html */ `
 ...
 * @public
 */
const tabPanelStyles = (context, definition) => esm_index_js_.css `
  ${(0,index_js_.display)('block')} :host {
    box-sizing: border-box;
    font-size: ${typeRampBaseFontSize};
    line-height: ${typeRampBaseLineHeight};
 ...
 */
const jpTabPanel = index_js_.TabPanel.compose({
    baseName: 'tab-panel',
    template: index_js_.tabPanelTemplate,
 ...
 * @public
 */
const tabStyles = (context, definition) => esm_index_js_.css `
    ${(0,index_js_.display)('inline-flex')} :host {
      box-sizing: border-box;
      font-family: ${bodyFont};
      font-size: ${typeRampBaseFontSize};
 ...
 */
const jpTab = index_js_.Tab.compose({
    baseName: 'tab',
    template: index_js_.tabTemplate,
    styles: tabStyles
});
/**
 * Base class for Tab
 ...
 * @public
 */
const tabsStyles = (context, definition) => esm_index_js_.css `
    ${(0,index_js_.display)('grid')} :host {
      box-sizing: border-box;
      font-family: ${bodyFont};
      font-size: ${typeRampBaseFontSize};
 ...
 */
const jpTabs = index_js_.Tabs.compose({
    baseName: 'tabs',
    template: index_js_.tabsTemplate,
    styles: tabsStyles
});
 ...
 * @public
 */
const textAreaStyles = (context, definition) => esm_index_js_.css `
    ${(0,index_js_.display)('inline-block')} :host {
      font-family: ${bodyFont};
      outline: none;
      user-select: none;
 ...
 * @internal
 */
class TextArea extends index_js_.TextArea {
    constructor() {
        super(...arguments);
        /**
         * The appearance of the element.
 ...
 * {@link https://developer.mozilla.org/en-US/docs/Web/API/ShadowRoot/delegatesFocus | delegatesFocus}
 */
const jpTextArea = TextArea.compose({
    baseName: 'text-area',
    baseClass: index_js_.TextArea,
    template: index_js_.textAreaTemplate,
 ...
 * @public
 */
const textFieldStyles = (context, definition) => esm_index_js_.css `
  ${BaseFieldStyles}
 ...
 * @internal
 */
class TextField extends index_js_.TextField {
    constructor() {
        super(...arguments);
        /**
         * The appearance of the element.
 ...
 * {@link https://developer.mozilla.org/en-US/docs/Web/API/ShadowRoot/delegatesFocus | delegatesFocus}
 */
const jpTextField = TextField.compose({
    baseName: 'text-field',
    baseClass: index_js_.TextField,
    template: index_js_.textFieldTemplate,
 ...
 * @public
 */
const toolbarStyles = (context, definition) => esm_index_js_.css `
    ${(0,index_js_.display)('inline-flex')} :host {
 ...
 * @public
 */
class FoundationToolbar extends index_js_.FoundationElement {
    constructor() {
        super(...arguments);
        /**
     ...
     */
    get activeIndex() {
        esm_index_js_.Observable.track(this, 'activeIndex');
        return this._activeIndex;
    }
    set activeIndex(value) {
        if (this.$fastController.isConnected) {
            this._activeIndex = (0,numbers/* limit */.b9)(0, this.focusableElements.length - 1, value);
            esm_index_js_.Observable.notify(this, 'activeIndex');
        }
    }
    slottedItemsChanged() {
        if (this.$fastController.isConnected) {
    ...
    connectedCallback() {
        super.connectedCallback();
        this.direction = (0,index_js_.getDirection)(this);
    }
    /**
...
__decorate([
    (0,esm_index_js_.attr)({ attribute: 'aria-labelledby' })
], DelegatesARIAToolbar.prototype, "ariaLabelledby", void 0);
__decorate([
    (0,esm_index_js_.attr)({ attribute: 'aria-label' })
], DelegatesARIAToolbar.prototype, "ariaLabel", void 0);
(0,index_js_.applyMixins)(DelegatesARIAToolbar, index_js_.ARIAGlobalStatesAndProperties);
(0,index_js_.applyMixins)(FoundationToolbar, index_js_.StartEnd, DelegatesARIAToolbar);
/**
 * @internal
 */
...
const jpToolbar = Toolbar.compose({
    ...
    template: index_js_.toolbarTemplate,
...
const tooltipStyles = (context, definition) => {
    const anchoredRegionTag = context.tagFor(index_js_.AnchoredRegion);
    return esm_index_js_.css `
    :host {
      contain: size;
      overflow: visible;
 ...
 */
const jpTooltip = index_js_.Tooltip.compose({
    baseName: 'tooltip',
    template: index_js_.tooltipTemplate,
...
const tree_item_styles_ltr = esm_index_js_.css `
  .expand-collapse-glyph {
    transform: rotate(0deg);
  }
...
`;
const tree_item_styles_rtl = esm_index_js_.css `
  .expand-collapse-glyph {
    transform: rotate(180deg);
  }
  :host(.nested) .expand-collapse-button {
 ...
 * @public
 */
const expandCollapseButtonSize = esm_index_js_.cssPartial `((${baseHeightMultiplier} / 2) * ${designUnit}) + ((${designUnit} * ${density}) / 2)`;
const expandCollapseHoverBehavior = index_js_.DesignToken.create('tree-item-expand-collapse-hover').withDefault((target) => {
    const recipe = neutralFillStealthRecipe.getValueFor(target);
    return recipe.evaluate(target, recipe.evaluate(target).hover).hover;
});
const selectedExpandCollapseHoverBehavior = index_js_.DesignToken.create('tree-item-expand-collapse-selected-hover').withDefault((target) => {
 ...
 * @public
 */
const treeItemStyles = (context, definition) => esm_index_js_.css `
    /**
    ...
    :host(:${index_js_.focusVisible}) .positioning-region {
      border-color: ${accentFillFocus};
      box-shadow: 0 0 0 calc((${focusStrokeWidth} - ${strokeWidth}) * 1px)
    ...
    ::slotted(${context.tagFor(index_js_.TreeItem)}) {
      --tree-item-nested-width: 1em;
      --expand-collapse-button-nested-width: calc(${heightNumber} * -1px);
    }
  `.withBehaviors(new DirectionalStyleSheetBehavior(tree_item_styles_ltr, tree_item_styles_rtl), (0,index_js_.forcedColorsStylesheetBehavior)(esm_index_js_.css `
      :host {
        forced-color-adjust: none;
        border-color: transparent;
        background: ${SystemColors.Field};
 ...
 *
 */
const jpTreeItem = index_js_.TreeItem.compose({
    baseName: 'tree-item',
    template: index_js_.treeItemTemplate,
 ...
 * @public
 */
const treeViewStyles = (context, definition) => esm_index_js_.css `
  ${(0,index_js_.display)('flex')} :host {
    flex-direction: column;
    align-items: stretch;
 ...
 *
 */
const jpTreeView = index_js_.TreeView.compose({
    baseName: 'tree-view',
    template: index_js_.treeViewTemplate,
 ...
 * @public
 */
const pickerStyles = (context, definition) => esm_index_js_.css `
  .region {
    z-index: 1000;
    overflow: hidden;
    display: flex;
 ...
 * @public
 */
const pickerMenuStyles = (context, definition) => esm_index_js_.css `
    :host {
      background: ${fillColor};
      --elevation: 11;
      /* TODO: a mechanism to manage z-index across components
 ...
 * @public
 */
const pickerMenuOptionStyles = (context, definition) => esm_index_js_.css `
    :host {
      display: flex;
      align-items: center;
      justify-items: center;
    ...
    :host(:${index_js_.focusVisible}[role="listitem"]) {
      border-color: ${design_tokens_focusStrokeOuter};
      background: ${neutralFillStealthFocus};
    }
 ...
 * @public
 */
const pickerListStyles = (context, definition) => esm_index_js_.css `
        :host {
            display: flex;
            flex-direction: row;
 ...
 * @public
 */
const pickerListItemStyles = (context, definition) => esm_index_js_.css `
    :host {
      display: flex;
      align-items: center;
      justify-items: center;
 ...
 */
const jpPicker = index_js_.Picker.compose({
    baseName: 'draft-picker',
    template: index_js_.pickerTemplate,
    styles: pickerStyles,
    shadowOptions: {}
});
/**
 ...
 * @public
 */
class PickerMenu extends index_js_.PickerMenu {
    /**
     * @public
     */
    connectedCallback() {
 ...
 */
const jpPickerMenu = PickerMenu.compose({
    baseName: 'draft-picker-menu',
    baseClass: index_js_.PickerMenu,
    template: index_js_.pickerMenuTemplate,
 ...
 */
const jpPickerMenuOption = index_js_.PickerMenuOption.compose({
    baseName: 'draft-picker-menu-option',
    template: index_js_.pickerMenuOptionTemplate,
 ...
 *
 */
const jpPickerList = index_js_.PickerList.compose({
    baseName: 'draft-picker-list',
    template: index_js_.pickerListTemplate,
 ...
 */
const jpPickerListItem = index_js_.PickerListItem.compose({
    baseName: 'draft-picker-list-item',
    template: index_js_.pickerListItemTemplate,
...
function provideJupyterDesignSystem(element) {
    return index_js_.DesignSystem.getOrCreate(element).withPrefix('jp');
}
...
//# sourceMappingURL=4503.3cf4d51a32c54795c0c1.js.map?v=3cf4d51a32c54795c0c1