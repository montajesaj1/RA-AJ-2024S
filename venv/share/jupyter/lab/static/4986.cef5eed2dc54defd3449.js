"use strict";
(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([[4986],{
...
var index_js_ = __webpack_require__(37496);
// EXTERNAL MODULE: consume shared module (default) style-mod@^4.0.0 (strict) (fallback: ./node_modules/style-mod/src/style-mod.js)
var style_mod_js_ = __webpack_require__(67737);
...
const baseThemeID = /*@__PURE__*/style_mod_js_.StyleModule.newName(), baseLightID = /*@__PURE__*/style_mod_js_.StyleModule.newName(), baseDarkID = /*@__PURE__*/style_mod_js_.StyleModule.newName();
const lightDarkIDs = { "&light": "." + baseLightID, "&dark": "." + baseDarkID };
function buildTheme(main, spec, scopes) {
    return new style_mod_js_.StyleModule(spec, {
        finish(sel) {
...
class EditorView {
    ...
    */
    ...
    mountStyles() {
        ...
        style_mod_js_.StyleModule.mount(this.root, this.styleModules.concat(baseTheme$1).reverse(), nonce ? { nonce } : undefined);
    }
    readMeasured() {
    ...
    */
    static theme(spec, options) {
        let prefix = style_mod_js_.StyleModule.newName();
...
function wrappedLine(view, pos, inside) {
    let range = index_js_.EditorSelection.cursor(pos);
...
//# sourceMappingURL=4986.cef5eed2dc54defd3449.js.map?v=cef5eed2dc54defd3449