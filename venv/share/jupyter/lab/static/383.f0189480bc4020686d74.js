(self["webpackChunk_jupyterlab_application_top"] = self["webpackChunk_jupyterlab_application_top"] || []).push([[383,4155],{
...
/* harmony import */ var _object_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(59735);
/**
...
/* harmony export */ });
/* harmony import */ var _map_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(72382);
/* harmony import */ var _set_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(48307);
/* harmony import */ var _array_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7049);
/**
...
var observable = __webpack_require__(58290);
// EXTERNAL MODULE: ./node_modules/lib0/array.js
var array = __webpack_require__(7049);
// EXTERNAL MODULE: ./node_modules/lib0/math.js
var lib0_math = __webpack_require__(14247);
// EXTERNAL MODULE: ./node_modules/lib0/map.js
var map = __webpack_require__(72382);
...
var lib0_function = __webpack_require__(97027);
 ...
 */
const browser_cryptoRandomBuffer = isoCrypto !== null
  ? len => {
    // browser
...
const uint32 = () => new Uint32Array(browser_cryptoRandomBuffer(4))[0]
...
var lib0_set = __webpack_require__(48307);
...
var lib0_time = __webpack_require__(20817);
...
var object = __webpack_require__(59735);
    ...
    dss[dssI].clients.forEach((delsLeft, client) => {
      if (!merged.clients.has(client)) {
        ...
        for (let i = dssI + 1; i < dss.length; i++) {
          array/* appendTo */.s7(dels, dss[i].clients.get(client) || []);
        }
...
const addToDeleteSet = (ds, client, clock, length) => {
  map/* setIfUndefined */.Yu(ds.clients, client, () => []).push(new DeleteItem(clock, length));
};
...
const writeDeleteSet = (encoder, ds) => {
  ...
  array/* from */.Dp(ds.clients.entries())
    .sort((a, b) => b[0] - a[0])
...
const readDeleteSet = decoder => {
  ...
  for (let i = 0; i < numClients; i++) {
    ...
    if (numberOfDeletes > 0) {
      const dsField = map/* setIfUndefined */.Yu(ds.clients, client, () => []);
...
class Doc extends observable/* Observable */.y {
  ...
  getSubdocGuids () {
    return new Set(array/* from */.Dp(this.subdocs).map(doc => doc.guid))
  }
   ...
   */
  destroy () {
    array/* from */.Dp(this.subdocs).forEach(subdoc => subdoc.destroy());
    const item = this._item;
    if (item !== null) {
      this._item = null;
...
const writeClientsStructs = (encoder, store, _sm) => {
  ...
  array/* from */.Dp(sm.entries()).sort((a, b) => b[0] - a[0]).forEach(([client, clock]) => {
    // @ts-ignore
...
const integrateStructs = (transaction, store, clientsStructRefs) => {
  ...
  let clientsStructRefsIds = array/* from */.Dp(clientsStructRefs.keys()).sort((a, b) => a - b);
...
const writeStateVector = (encoder, sv) => {
  ...
  array/* from */.Dp(sv.entries()).sort((a, b) => b[0] - a[0]).forEach(([client, clock]) => {
...
class UndoManager extends observable/* Observable */.y {
  ...
  constructor (typeScope, {
    ...
    doc = /** @type {Doc} */ (array/* isArray */.kJ(typeScope) ? typeScope[0].doc : typeScope.doc)
  } = {}) {
    super();
    /**
   ...
   */
  addToScope (ytypes) {
    ytypes = array/* isArray */.kJ(ytypes) ? ytypes : [ytypes];
          ...
          if (this.adds(item)) {
            ...
            if (this.deletes(item)) {
              if (prev !== null && this.deletes(prev)) {
                action = 'delete';
                oldValue = array/* last */.Z$(prev.content.getContent());
              } else {
                return
              }
            } else {
            ...
            if (this.deletes(item)) {
              action = 'delete';
              oldValue = array/* last */.Z$(/** @type {Item} */ item.content.getContent());
            } else {
              return // nop
            }
          }
...
class YXmlFragment extends AbstractType {
  ...
  querySelectorAll (query) {
    query = query.toUpperCase();
    // @ts-ignore
    return array/* from */.Dp(new YXmlTreeWalker(this, element => element.nodeName && element.nodeName.toUpperCase() === query))
  }
...
//# sourceMappingURL=383.f0189480bc4020686d74.js.map?v=f0189480bc4020686d74